...
def main( ):
    ...
    # diff-global values:
    max_diff_glob_coal_expl_tot=\
        explain_analysis_dict["max_diff_glob_coal_expl_tot"]
    max_diff_glob_group_coal_expl_tot=\
        explain_analysis_dict["max_diff_glob_group_coal_expl_tot"]
    max_diff_glob_coal_expl_nonsingl_tot=\
        explain_analysis_dict["max_diff_glob_coal_expl_nonsingl_tot"]
    max_diff_glob_group_coal_expl_nonsingl_tot=\
        explain_analysis_dict["max_diff_glob_group_coal_expl_nonsingl_tot"]
    ...
    if True:
        ...
        # plot differences of total individual versus total group explanations 
        # for a list of models (including singletons):
        ...
        plt.bar( position[:-1]+(1/2)*bar_width,
                np.array(max_diff_glob_group_coal_expl_tot)[thresholds_idx_plot],
                color = "lime",
                alpha = 1, 
                width = bar_width,
                label = r'''$|Ow^{\mathcal{P}}(\Delta f)|$''',
                edgecolor = bar_edgecolor)
        ...
        # plot differences of total individual versus total group explanations 
        # for a list of models (excluding singletons):
        ...
        plt.bar( position[:-1]-(1/2)*bar_width,
                np.array(max_diff_glob_coal_expl_nonsingl_tot)[thresholds_idx_plot],
                color = "magenta",
                alpha = 1, 
                width = bar_width,
                label = r'''$|Ow(\Delta f)|$''',
        ...
        plt.bar( position[:-1]+(1/2)*bar_width,
                np.array(max_diff_glob_group_coal_expl_nonsingl_tot)[thresholds_idx_plot],
                color = "lime",
                alpha = 1, 
                width = bar_width,
                label = r'''$|Ow^{\mathcal{P}}(\Delta f)|$''',
    ...
    if True: # ranking
        ...
        L2_norm_owen_expl     = explain_analysis_dict["L2_norm_owen_expl"]		
        L2_norm_owen_expl_tot = explain_analysis_dict["L2_norm_owen_expl_tot"]
        L2_norm_group_owen_expl = explain_analysis_dict["L2_norm_group_owen_expl"]
